...
public class LargestNumberSolverJavaSort<T> {
	...
	public static Integer[] findKthLargest(List<Integer[]> list, int k) throws IllegalArgumentException {
		...
		if (k >= 0 && k <= list.size() - 1) {
			...
			// Uses sort built into Java
			list.sort((o1, o2) -> {return LargestNumberSolverJavaSort.findLargestInt(o1) - LargestNumberSolverJavaSort.findLargestInt(o2);});
